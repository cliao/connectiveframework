...
var SoftScroll = /*28 Sept 2012*/
{
 /*** Download with instructions from: http://scripterlative.com?softscroll ***/

 DEBUG:false, doXScroll : true, doYScroll : true,
 timer:null, lastX:-1, lastY:-1, xHalted:false, yHalted:false, step:50, targetDisp:null, stepTarget:{x:0,y:0}, logged:5, startJump:location.href.match(/#([^\?]+)\??/), currentAnchor:null, initialised:false, initialTarget:"", showHref:false, targetFrame:self, always:false,
